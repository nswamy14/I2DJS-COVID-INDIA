<template>
	<div class="main-container">
		...
		<map-container :covidDistrictData="covidDistrictData" :dataRange="dataRange" :dataType="dataType"
					   class="map-container" id="map-container"
					   v-if="covidDistrictData.length !== 0"></map-container>
		<div class="timeline-container">
			<timeline-view :timelineData="timelineData" id="timeline-container"
						   v-if="timelineData.data.length !== 0"></timeline-view>
		</div>
